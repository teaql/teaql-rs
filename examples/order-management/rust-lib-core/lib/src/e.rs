...
impl E {
    pub fn commerce_platform<'a>(value: &'a crate::CommercePlatform) -> crate::CommercePlatformExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("CommercePlatform(id={})", value.id()));
        crate::CommercePlatformExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
    ...
    pub fn customer_order<'a>(value: &'a crate::CustomerOrder) -> crate::CustomerOrderExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("CustomerOrder(id={})", value.id()));
        crate::CustomerOrderExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
    ...
    pub fn order_line<'a>(value: &'a crate::OrderLine) -> crate::OrderLineExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("OrderLine(id={})", value.id()));
        crate::OrderLineExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }

    pub fn order_search_preset<'a>(value: &'a crate::OrderSearchPreset) -> crate::OrderSearchPresetExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("OrderSearchPreset(id={})", value.id()));
        crate::OrderSearchPresetExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
}
