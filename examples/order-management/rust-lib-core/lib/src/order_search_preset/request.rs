...
impl<R> OrderSearchPresetRequest<R> {
    ...
    pub(crate) async fn _execute_for_rows<'a, C>(
        self,
        context: &'a C,
    ) -> Result<SmartList<teaql_core::CompactRow>, TeaqlDataServiceError<C::OrderSearchPresetRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = context
...
impl<R: teaql_core::Entity> crate::PurposedQuery<OrderSearchPresetRequest<R>> {
    ...
    pub async fn execute_for_rows<'a, C>(self, context: &'a C) -> Result<teaql_core::SmartList<teaql_core::CompactRow>, crate::request_support::TeaqlDataServiceError<C::OrderSearchPresetRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
