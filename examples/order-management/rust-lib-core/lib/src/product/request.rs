...
impl<R> ProductRequest<R> {
    ...
    pub(crate) async fn _execute_for_rows<'a, C>(
        self,
        context: &'a C,
    ) -> Result<SmartList<teaql_core::CompactRow>, TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    {
        let repository = context
    ...
    pub(crate) async fn _execute_for_stream<'a, C>(
        self,
        context: &'a C,
    ) -> Result<TeaqlEntityStream<'a, R, TeaqlDataServiceError<C::ProductRepository<'a>>>, TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: TeaqlRepositoryProvider + ?Sized,
    ...
    pub fn select_self(mut self) -> Self {
        ...
        self.query = self.query.project("image_url");
    ...
    pub fn select_image_url(mut self) -> Self {
        self.query = self.query.project("image_url");
        self
    }

    pub fn project_image_url(self) -> Self {
        self.select_image_url()
    }

    pub fn select_image_url_raw(self, raw_sql_segment: impl Into<String>) -> Self {
        self.select_image_url_unsafe_raw(UnsafeRawSqlSegment::trusted(raw_sql_segment))
    }

    pub fn select_image_url_unsafe_raw(mut self, raw_sql_segment: UnsafeRawSqlSegment) -> Self {
        self.query_options
            .raw_projections
            .push(RawProjection::new("image_url", raw_sql_segment));
        self
    }

    pub fn group_by_image_url(self) -> Self {
        self.group_by("image_url")
    }

    pub fn group_by_image_url_as(self, alias: impl Into<String>) -> Self {
        let alias = alias.into();
        let mut request = self.group_by("image_url");
        request.query = request
            .query
            .project_expr(alias, Expr::column("image_url"));
        request
    }

    pub fn group_by_image_url_with_function(
        self,
        alias: impl Into<String>,
        function: AggregateFunction,
    ) -> Self {
        self.group_by("image_url")
            .aggregate_with_function("image_url", alias, function)
    }

    pub fn count_image_url(self) -> Self {
        self.count_image_url_as("image_url_count")
    }

    pub fn count_image_url_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_count_field("image_url", alias)
    }

    pub fn sum_image_url(self) -> Self {
        self.sum_image_url_as("sum_image_url")
    }

    pub fn sum_image_url_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_sum("image_url", alias)
    }

    pub fn avg_image_url(self) -> Self {
        self.avg_image_url_as("avg_image_url")
    }

    pub fn avg_image_url_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_avg("image_url", alias)
    }

    pub fn min_image_url(self) -> Self {
        self.min_image_url_as("min_image_url")
    }

    pub fn min_image_url_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_min("image_url", alias)
    }

    pub fn max_image_url(self) -> Self {
        self.max_image_url_as("max_image_url")
    }

    pub fn max_image_url_as(self, alias: impl Into<String>) -> Self {
        self.aggregate_max("image_url", alias)
    }

    pub fn unselect_image_url(mut self) -> Self {
        self.query.projection.retain(|field| field != "image_url");
        self.query_options.raw_projections.retain(|projection| projection.property_name != "image_url");
        self
    }
    ...
    pub fn create_image_url_criteria(
        operator: FieldOperator,
        values: impl IntoIterator<Item = impl Into<teaql_core::Value>>,
    ) -> Expr {
        field_operator_expr(
    ...
    pub fn with_image_url_is(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::eq("image_url", value));
        self
    }



    pub fn with_image_url_is_not(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::ne("image_url", value));
        self
    }

    pub fn with_image_url_greater_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("image_url", value));
        self
    }

    pub fn with_image_url_greater_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gte("image_url", value));
        self
    }

    pub fn with_image_url_less_than(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("image_url", value));
        self
    }

    pub fn with_image_url_less_than_or_equal_to(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lte("image_url", value));
        self
    }

    pub fn with_image_url_between(
        mut self,
        lower: impl Into<teaql_core::Value>,
        upper: impl Into<teaql_core::Value>,
    ) -> Self {
        self.query = self.query.and_filter(Expr::between("image_url", lower, upper));
        self
    }

    pub fn with_image_url_between_range<T>(mut self, range: DateRange<T>) -> Self
    where
        T: Into<teaql_core::Value>,
    {
        self.query = self.query.and_filter(Expr::between(
    ...
    pub fn with_image_url_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::contain("image_url", value));
        self
    }

    pub fn with_image_url_not_containing(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_contain("image_url", value));
        self
    }

    pub fn with_image_url_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::begin_with("image_url", value));
        self
    }

    pub fn with_image_url_not_starting_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_begin_with("image_url", value));
        self
    }

    pub fn with_image_url_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::end_with("image_url", value));
        self
    }

    pub fn with_image_url_not_ending_with(mut self, value: impl Into<String>) -> Self {
        self.query = self.query.and_filter(Expr::not_end_with("image_url", value));
        self
    }

    pub fn with_image_url_sounding_like(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::sound_like("image_url", value));
        self
    }
    pub fn with_image_url_before(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::lt("image_url", value));
        self
    }

    pub fn with_image_url_after(mut self, value: impl Into<teaql_core::Value>) -> Self {
        self.query = self.query.and_filter(Expr::gt("image_url", value));
        self
    }

    pub fn with_image_url_is_unknown(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_null("image_url"));
        self
    }



    pub fn with_image_url_is_known(mut self) -> Self {
        self.query = self.query.and_filter(Expr::is_not_null("image_url"));
        self
    }


    pub fn order_by_image_url_asc(mut self) -> Self {
        self.query = self.query.order_asc("image_url");
        self
    }

    pub fn order_by_image_url_desc(mut self) -> Self {
        self.query = self.query.order_desc("image_url");
        self
    }

    pub fn order_by_image_url_asc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_asc("image_url");
        self
    }

    pub fn order_by_image_url_desc_using_gbk(mut self) -> Self {
        self.query = self.query.order_gbk_desc("image_url");
        self
    }
...
impl<R: teaql_core::Entity> crate::PurposedQuery<ProductRequest<R>> {
    ...
    pub fn new_entity<C>(&self, context: &C) -> crate::Product
    where
        C: crate::TeaqlRuntime + ?Sized,
    {
        self.require_comment();
        let mut entity = crate::Product::runtime_new(context.user_context().entity_runtime_state());
        if let Ok(id) = context.user_context().next_id(crate::Product::ENTITY_NAME) {
            entity.update_id(id);
        }
    ...
    pub async fn execute_for_list<'a, C>(self, context: &'a C) -> Result<teaql_core::SmartList<R>, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_rows<'a, C>(self, context: &'a C) -> Result<teaql_core::SmartList<teaql_core::CompactRow>, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_stream<'a, C>(self, context: &'a C) -> Result<crate::request_support::TeaqlEntityStream<'a, R, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
        R: teaql_core::Entity + 'a,
    {
    ...
    pub async fn execute_for_first<'a, C>(self, context: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_one<'a, C>(self, context: &'a C) -> Result<Option<R>, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
    ...
    pub async fn execute_for_count<'a, C>(self, context: &'a C) -> Result<u64, crate::request_support::TeaqlDataServiceError<C::ProductRepository<'a>>>
    where
        C: crate::request_support::TeaqlRepositoryProvider + ?Sized,
    {
