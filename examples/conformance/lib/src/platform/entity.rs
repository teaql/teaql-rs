...
impl Platform {
    ...
    pub fn work_item_list(
        &self,
    ) -> teaql_runtime::RelationHandle<'_, teaql_core::SmartList<crate::WorkItem>> {
    ...
    pub fn eval_work_item_list(
        &self,
    ) -> teaql_core::eval::EvalResult<&teaql_core::SmartList<crate::WorkItem>> {
        ...
        match relation.state() {
            ...
            teaql_runtime::LoadedRelation::NotLoaded => teaql_core::eval::EvalResult::NotLoaded {
                failed_node: "work_item_list".to_string(),
                attempted_path: "work_item_list".to_string(),
            },
        }
    }
}
