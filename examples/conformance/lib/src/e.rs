...
impl E {
    ...
    pub fn work_item<'a>(value: &'a crate::WorkItem) -> crate::WorkItemExpression<'a> {
        let root_desc = std::sync::Arc::new(format!("WorkItem(id={})", value.id()));
        crate::WorkItemExpression::new(teaql_core::eval::EvalResult::Value(value), root_desc)
    }
}
